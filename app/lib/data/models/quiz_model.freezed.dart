...
class _$QuizContentImpl implements _QuizContent {
  const _$QuizContentImpl(
      {this.courseId, final List<QuizQuestion> questions = const []})
...
abstract class _QuizContent implements QuizContent {
  const factory _QuizContent(
      {final String? courseId,
      final List<QuizQuestion> questions}) = _$QuizContentImpl;
...
class _$QuizModelImpl extends _QuizModel {
  ...
  @override
  String toString() {
    return 'QuizModel(id: $id, projectId: $projectId, courseId: $courseId, content: $content, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, projectId, courseId, content, createdAt);
...
abstract class _QuizModel extends QuizModel {
  const factory _QuizModel(
      ...
      required final DateTime createdAt}) = _$QuizModelImpl;
