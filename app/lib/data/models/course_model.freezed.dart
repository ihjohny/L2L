...
abstract class _CourseContent implements CourseContent {
  const factory _CourseContent(
      ...
      final List<CourseLesson> lessons}) = _$CourseContentImpl;
...
abstract class $CourseModelCopyWith<$Res> {
  ...
  @useResult
  $Res call(
      {String id, String projectId, CourseContent content, DateTime createdAt});
...
class _$CourseModelImpl extends _CourseModel {
  ...
  @override
  String toString() {
    return 'CourseModel(id: $id, projectId: $projectId, content: $content, createdAt: $createdAt)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, id, projectId, content, createdAt);
...
abstract class _CourseModel extends CourseModel {
  const factory _CourseModel(
      ...
      required final DateTime createdAt}) = _$CourseModelImpl;
